...
use Modules\Core\Infrastructure\Downloads\NullReleaseDownloadLocator;
...
final class CoreServiceProvider extends BaseModuleServiceProvider
{
    ...
    public function register(): void
    {
        ...
        // Safe default: no downloads on offer. Downloads overrides it (ADR 0008).
        $this->app->bind(ReleaseDownloadLocator::class, NullReleaseDownloadLocator::class);
    }
}
